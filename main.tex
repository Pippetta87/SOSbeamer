...
In questa tesina mi sono occupato dei modi normali gravo-acustici solari, cio\'e oscillazioni  stazionarie attorno alla struttura di equilibrio le cui caratteristiche sono determinate dal profilo radiale della densit\'a e velocit\'a del suono nell'interno solare: la disciplina che studia la propagazione delle onde all'interno del Sole \'e eliosismologia.

L'osservazione delle frequenze dei modi normali avviene tramite lo spostamento Doppler di righe di assorbimento dell'atmosfera; negli anni '60 Leigthon e collaboratori osservarono per primi un comportamento oscillatorio con periodo 5 minuti e dimensioni cartteristiche di qualche megametro, in seguito il fenomeno \'e stato spiegato come sovrapposizione di un gran numero di modi acustici confinati in cavit'a risonanti.
...
%La legge di conservazione dell'energia interna determina la relazione tra il calore trasferito per unit\'a di massa, cio\'e bilancio netto fra energia prodotta dalle reazioni nucleari e il gradiente del flusso e cambiamento di temperatura espansione/compressione: si ha situazione stazionaria quando l'energia prodotta dalle reazioni nucleari bilancia il flusso uscente (divergenza del flusso uscente proporzionale a $\nabla T\propto\nabla P$).
...
La prima legge della termodinamica apllicata alla struttura stellare si legge che se esiste un trasferimento netto di calore per elemento di massa unitaria dovuto a un disequilibrio tra energia prodotta per unit\'a di massa dalla reazioni nucleari e divergenza del flusso l'elemento subisce modifiche dello stato termodinamico.

Per determinare il gradiente termico considero le caratteristiche del trasporto di energia dalle regioni pi\'u calde alla superficie: oltre al trasporto radiativo devo considerare la convezione presente nella regione esterna per stelle con $M<1.1\msun{}$.
