...
Negli interni stellari il cammino libero medio di un fotone $\invers{(\kappa_{\nu}\rho)}$ \'e molto breve quindi considero considero localmente equilibrio radiazione-materia. L'intensit\'a di radiazione attraverso il punto $\vec{P}$ nella direzione $\hat{s}$ \'e determinata dall'intensit\'a di corpo nero locale e dal contributo anisotropo della radiazione proveniente dagli strati circostanti: quest'anisotropia dovuta al gradiente termico si descrive tramite un'espansione di Taylor al prim'ordine nel cammino libero medio del fotone $\nu$.
