...
\begin{frame}{Evoluzione chimica: reazioni nucelari e diffusione.}
...
\begin{frame}{Velocit\'a del suono}
...
\begin{block}{Equazione del moto perturbato e variazioni nella struttura di equilibrio}
...
Confronto tra differenze relative nella velocit\'a del suono tra un modello con composizione $\midfrac{Z}{X}=0.023$ (GS98), linea nera, e uno con $\midfrac{Z}{X}=0.018$ (AGSS09), linea rossa. La banda rossa intorno allo zero indica l'errore dovuto alle tecniche di inversione, alle incertezze sulle frequenze e alla residua dipendenza dell'inversione dal modello solare.
...
Riassumo le caratteristiche della zona convettiva, ricavati tramite inversione e le confronto con quelle di modelli con diversa composizione. Le differenze nel profilo della velocit\'a del suono sono  correlate con la posizione della zona convettiva poich\'e il modello non riproduce correttamente il gradiente termico.
