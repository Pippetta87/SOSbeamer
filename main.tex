...
L'eliosismologia nasce all'inizio degli anni ''60 quando Leighton e collaboratori osservarono un comportamento oscillatorio nell'atmosfera solare con periodo attorno ai 5 minuti.

Onde acustiche: 

Cavit\'a risonanti di diversa profondit\'a dalla superficie radiale - Interferenza costruttiva: entro i bordi della cavit\'a sono contenute un numero semi-intero di lunghezze d'onda

La relazione di dispersione per onde acustiche $\omega^2=|\vec{k}|^2c_s^2$.

Risultato inversione $c_s$, visto errore sistematico $2.5\%$ sostanziale accordo tra profilo solare e predetto dal modello.
...
\begin{block}{Equazione del moto perturbato}
...
\begin{block}{Variazione nei modi per variazione in struttura, equazione di stato e composizione}
