...
\begin{block}{Regioni di stabilit\'a convettiva}
...
Nelle condizioni tipiche degli interni stellari i fotoni hanno cammino libero medio molto breve $\invers{(\kappa_{\nu})}$ quindi posso considerare materia radiazione in LTE: il flusso \'e trasportato dall'anisotropia nella radiazione di Plank dovuta generata appunto dal gradiente termico.
Il flusso \'e proporzionale al gradiente e all'opacit\'a per frequenza $\nu$ mediata rispetto alla derivata della funzione di Plank rispetto alla temperatura.

Le stelle con $M<1.1\msun{}$ sono caratterizzata da una zona convettiva esterna in cui $\nrad{}>\nad{}$ e dove piccole perturbazioni adiabatiche di elementi di gas vengono amplificate cos\'i trasportando il loro eccesso di calore su grandi distanze.
