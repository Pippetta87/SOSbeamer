...
\begin{figure}[!ht]
\subfigure[Avant la diode]{\includegraphics[width=0.4\textwidth,keepaspectratio]{ionfraction}}
~
\subfigure[Après le détecteur de crête]{\includegraphics[width=0.4\textwidth,keepaspectratio]{gamma1eos}}
