...
\begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=0.9\textwidth,keepaspectratio]{ionfraction}\label{ionfraction}
...
~
\begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=0.9\textwidth,keepaspectratio]{gamma1eos}\label{fig:gamma1eos}
