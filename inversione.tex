...
\item modi distinti sono confinati in cavit\'a di profondit\'a diversa/ le ampiezze di oscillazione hanno differente comportamento spaziale (profilo radiale di $(P,\rho,\Gamma_1)$, $Y_{ph}$).

\item l'approssimazione asintotica: inversione legge di Duvall. valida nelle regioni in cui le autofunzioni variano molto pi\'u rapidamente delle grandezze di equilibrio
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\captionof{figure}{Profilo radiale di $c_s^2$ determinato invertendo \eqref{eq:analinversionc} dalle frequenze dei modi osservate. Da \cite{christensen1985speed}.}\label{fig:soundspeedccm}
\end{minipage}
...
\begin{frame}{Legge Duvall diferenziale}
...
\begin{frame}{Inversione di $H_1$ e $h_2$}
...
\begin{frame}{Differenze idrogeno/zona ionizzazione}
...
\begin{frame}{Regioni superficiali}
...
\begin{frame}{Determinazione variazioni velocit\'a del suono}
